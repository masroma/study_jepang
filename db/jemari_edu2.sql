...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 17 Jan 2026 pada 23.26
...
(15, 4, 15, 'ID', 'meghantara', 'Homepage', NULL, 'banner-3-1-1600727828-1741675500.png', 'https://blog.jemari-edu.web.id/info', 1, 'Publish', NULL, 'Ya', '2025-03-11 06:45:01'),
...
(1, 'Perikanan', 'Ikan', 'C:\\Users\\HP\\AppData\\Local\\Temp\\phpC57D.tmp', 'test', 1, 'Publish', '2026-01-14 05:41:16', '2026-01-14 05:41:16');
...
(6, 'ID', 'happy-tutor', 'Happy Tutor', 'meghantara didampingi oleh tutor-tutor dan instruktur yang berpengalaman di bidangnya.', 1);
...
(1, 'Aditya Eka Saputra', 'Direktur', 'Osaka Jepang', 'test', '1768397068.png', NULL, 2020, 5, NULL, NULL, 1, 'Publish', '2026-01-14 06:24:28', '2026-01-14 06:24:28');
...
(1, 'test', 'C:\\Users\\HP\\AppData\\Local\\Temp\\php3AB6.tmp', 'test 123', 'Osaka Jepang', '3', '4', '100.000.000', 'A', 1, 'Publish', '2026-01-14 05:39:36', '2026-01-14 05:39:36');
...
(2, 'BNI SYARIAH DEPOK', '0611-9927-06', 'CV meghantara', 'Logo_BNI_Syariah.png', 2, '2019-11-12 23:54:18'),
...
(4, 'Andoyo Cakep', 'javawebmedia@gmail.com', 'javawebmedia', 'd033e22ae348aeb5660fc2140aec35850c4da997', 'Admin', NULL, 'testimonials-1.jpg', '2026-01-14 00:54:09'),
...
--
ALTER TABLE `industri`
  MODIFY `id_industri` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `kisah_sukses`
  MODIFY `id_kisah` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `program_masa_depan`
  MODIFY `id_program` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
