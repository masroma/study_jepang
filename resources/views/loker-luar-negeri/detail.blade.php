...
<header class="relative w-full min-h-[400px] hero-bg flex items-center pt-24 md:pt-20 overflow-hidden">
  <div class="absolute inset-0 w-full h-full z-0 pointer-events-none">
    @if($loker->gambar)
    <img src="{{ $loker->gambar }}" class="w-full h-full object-cover opacity-40" alt="{{ $loker->judul_loker }}" onerror="this.src='{{ asset('template/img/image6.png') }}'" />
    @else
  ...
  <div class="container max-w-7xl mx-auto px-6 relative z-10">
    <div class="max-w-3xl pt-4 md:pt-10">
      <a href="{{ url('loker-luar-negeri') }}" class="text-brand-pink hover:underline mb-4 inline-flex items-center">
  ...
  <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
    ...
    <div class="lg:col-span-1">
      <div class="bg-white rounded-2xl shadow-soft p-8 sticky top-24">
        ...
        @else
        <form action="{{ url('loker-luar-negeri/proses_pendaftaran') }}" method="post" enctype="multipart/form-data">
          @csrf
          ...
          <div class="mb-4">
            ...
            <input type="text" name="pendidikan_terakhir" id="pendidikan_terakhir" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-pink" value="{{ old('pendidikan_terakhir') }}" placeholder="Contoh: SMA/SMK, D3, S1">
          </div>
          ...
          <div class="mb-4">
            ...
            <textarea name="pengalaman" id="pengalaman" rows="4" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-pink" placeholder="Ceritakan pengalaman kerja Anda">{{ old('pengalaman') }}</textarea>
          </div>
...
<section class="py-16 bg-gray-50">
  <div class="max-w-7xl mx-auto px-6">
    <div class="text-center mb-12">
      ...
      <p class="text-gray-500 text-sm font-medium">Lihat lowongan kerja luar negeri lainnya yang tersedia</p>
    </div>
