        ...
        <div class="bg-white rounded-3xl shadow-soft p-8 md:p-10 border border-gray-100">
          ...
          <form action="{{ url('login/check') }}" method="POST" class="space-y-6">
            ...
            <div>
              ...
              <input type="text" id="username" name="username" required class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-brand-pink focus:ring-2 focus:ring-brand-pink/20 outline-none transition text-sm font-medium" placeholder="Masukkan username" />
            </div>
