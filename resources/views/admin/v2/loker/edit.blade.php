...
<div class="space-y-6">
    <!-- Header -->
    <div>
        <h2 class="text-2xl font-bold text-gray-900">Edit Lowongan Pekerjaan</h2>
        <p class="text-sm text-gray-600 mt-1">Edit lowongan pekerjaan untuk ditampilkan di website</p>
    </div>

    <!-- Form -->
    <form method="POST" action="{{ url('admin/v2/loker/edit_proses') }}" enctype="multipart/form-data" class="space-y-6">
        @csrf
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="md:col-span-2">
                        ...
                        <input type="text" id="judul_loker" name="judul_loker" value="{{ old('judul_loker', $loker->judul_loker) }}" required
                    ...
                    <div>
                        ...
                        <input type="text" id="posisi" name="posisi" value="{{ old('posisi', $loker->posisi) }}" required
                            class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-brand-pink focus:ring-2 focus:ring-brand-pink/20 outline-none transition"
                    ...
                    <div>
                        ...
                        <input type="text" id="lokasi_kerja" name="lokasi_kerja" value="{{ old('lokasi_kerja', $loker->lokasi_kerja) }}"
                            class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-brand-pink focus:ring-2 focus:ring-brand-pink/20 outline-none transition"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="deskripsi_singkat" name="deskripsi_singkat" rows="3"
                            class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-brand-pink focus:ring-2 focus:ring-brand-pink/20 outline-none transition"
                            placeholder="Ringkasan singkat tentang lowongan (opsional)">{{ old('deskripsi_singkat', $loker->deskripsi_singkat) }}</textarea>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="isi_loker" name="isi_loker" rows="10" required
                            class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-brand-pink focus:ring-2 focus:ring-brand-pink/20 outline-none transition"
                            placeholder="Masukkan detail lengkap tentang lowongan pekerjaan">{{ old('isi_loker', $loker->isi_loker) }}</textarea>
                        @error('isi_loker')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <textarea id="persyaratan" name="persyaratan" rows="6"
                            class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-brand-pink focus:ring-2 focus:ring-brand-pink/20 outline-none transition"
                            placeholder="Sebutkan persyaratan yang dibutuhkan (satu per baris)">{{ old('persyaratan', $loker->persyaratan) }}</textarea>
                    ...
                    <div>
                        ...
                        <textarea id="tanggung_jawab" name="tanggung_jawab" rows="6"
                            class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-brand-pink focus:ring-2 focus:ring-brand-pink/20 outline-none transition"
                            placeholder="Sebutkan tanggung jawab pekerjaan (satu per baris)">{{ old('tanggung_jawab', $loker->tanggung_jawab) }}</textarea>
            ...
            <div class="border-t border-gray-200 pt-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input type="date" id="tanggal_mulai" name="tanggal_mulai" value="{{ old('tanggal_mulai', $loker->tanggal_mulai ? date('Y-m-d', strtotime($loker->tanggal_mulai)) : '') }}"
                            class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-brand-pink focus:ring-2 focus:ring-brand-pink/20 outline-none transition">
                        @error('tanggal_mulai')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="date" id="tanggal_selesai" name="tanggal_selesai" value="{{ old('tanggal_selesai', $loker->tanggal_selesai ? date('Y-m-d', strtotime($loker->tanggal_selesai)) : '') }}"
                            class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-brand-pink focus:ring-2 focus:ring-brand-pink/20 outline-none transition">
            ...
            <div class="border-t border-gray-200 pt-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        @if($loker->gambar)
                            <div class="mt-3">
                                <img src="{{ Storage::disk('s3')->url('assets/upload/image/loker/' . $loker->gambar) }}" alt="Current image" class="w-64 h-48 object-cover rounded-lg border border-gray-200">
