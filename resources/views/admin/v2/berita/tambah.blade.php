...
<div class="space-y-6">
    ...
    <div>
        ...
        <p class="text-sm text-gray-600 mt-1">Tambahkan berita baru untuk ditampilkan di website</p>
    </div>

    <!-- Form -->
    <form method="POST" action="{{ url('admin/v2/berita/tambah_proses') }}" enctype="multipart/form-data" class="space-y-6">
        @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="keywords" name="keywords" rows="2"
                            class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-brand-pink focus:ring-2 focus:ring-brand-pink/20 outline-none transition"
                            placeholder="Masukkan keywords untuk SEO, pisahkan dengan koma">{{ old('keywords') }}</textarea>
            ...
            <div class="border-t border-gray-200 pt-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="date" id="tanggal_publish" name="tanggal_publish" value="{{ old('tanggal_publish', date('Y-m-d')) }}"
                            class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-brand-pink focus:ring-2 focus:ring-brand-pink/20 outline-none transition">
                    ...
                    <div>
                        ...
                        <input type="time" id="jam_publish" name="jam_publish" value="{{ old('jam_publish', date('H:i')) }}"
                            class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-brand-pink focus:ring-2 focus:ring-brand-pink/20 outline-none transition">
                        @error('jam_publish')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <select id="status_berita" name="status_berita" required
                            class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-brand-pink focus:ring-2 focus:ring-brand-pink/20 outline-none transition">
                            <option value="Publish" {{ old('status_berita', 'Publish') == 'Publish' ? 'selected' : '' }}>Publish</option>
