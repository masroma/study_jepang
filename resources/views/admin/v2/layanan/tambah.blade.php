...
<div class="space-y-6">
    ...
    <div>
        ...
        <p class="text-sm text-gray-600 mt-1">Tambahkan layanan baru untuk ditampilkan di website</p>
    </div>

    <!-- Form -->
    <form method="POST" action="{{ url('admin/v2/layanan/tambah_proses') }}" enctype="multipart/form-data" class="space-y-6">
        @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="fitur" name="fitur" rows="6"
                            class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-brand-pink focus:ring-2 focus:ring-brand-pink/20 outline-none transition"
                            placeholder="Masukkan fitur layanan (satu per baris)">{{ old('fitur') }}</textarea>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="lokasi" name="lokasi" rows="3"
                            class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-brand-pink focus:ring-2 focus:ring-brand-pink/20 outline-none transition"
                            placeholder="Masukkan lokasi layanan (satu per baris). Contoh untuk warehousing: Jakarta - 5,000 m²">{{ old('lokasi') }}</textarea>
