  ...
  <div class="container max-w-7xl mx-auto px-6 relative z-10">
    <div class="max-w-4xl">
      ...
      <p class="text-gray-500 mb-8 max-w-2xl leading-relaxed text-sm md:text-base">
        Pusat pelatihan bahasa Jepang terpercaya dengan metode pembelajaran modern, instruktur berpengalaman, dan fasilitas lengkap.
      </p>
      <div class="flex items-center space-x-4 text-sm text-gray-600">
        <span>Program Pelatihan</span>
        <span>•</span>
        <span>Sertifikasi JLPT</span>
        <span>•</span>
        <span>Karir di Jepang</span>
      </div>
    </div>
  </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
      ...
      <div class="group bg-white rounded-2xl shadow-soft hover:shadow-xl transition-all duration-300 border border-transparent hover:border-gray-100 overflow-hidden cursor-pointer">
        <div class="h-48 overflow-hidden bg-gray-50">
          ...
          @else
            <img src="{{ asset('template/img/program-default.jpg') }}" class="w-full h-full object-contain bg-gray-50 group-hover:scale-110 transition duration-500" />
          @endif
        </div>
        <div class="p-6">
      ...
      <div class="bg-white rounded-2xl shadow-xl overflow-hidden flex flex-col">
        <div class="w-full relative">
          ...
          @if(!empty($testi->gambar))
            <img src="{{ asset($testi->gambar) }}" class="w-full h-48 object-contain bg-gray-50" />
          @else
            <img src="{{ asset('template/img/ChatGPT Image 18 Jan 2026, 07.02.36.png') }}" class="w-full h-48 object-contain bg-gray-50" />
          @endif
        </div>
